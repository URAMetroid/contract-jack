...
enum dprintfOutputType {
  dprintfOutputType_Unknown,
  dprintfOutputType_Nothing,
  dprintfOutputType_Monochrome,
  dprintfOutputType_Com1,
  dprintfOutputType_Com2,
  dprintfOutputType_File,
  dprintfOutputType_FileAppend,
  dprintfOutputType_STDOUT,
  dprintfOutputType_LPT1,
  dprintfOutputType_LPT2,
  dprintfOutputType_PRN
};
...
dprintfOutputType dprintfOutType = dprintfOutputType_Unknown;
...
void dprintfdoprint (char *Str) {
  ...
  switch (dprintfOutType) {
    case dprintfOutputType_Monochrome :
      dprintfmonoprint (Str);
      break;
    case dprintfOutputType_STDOUT :
      printf ("%s",Str);
      break;
	 case dprintfOutputType_LPT1 :
    case dprintfOutputType_LPT2 :
    case dprintfOutputType_PRN :
    case dprintfOutputType_File :
      if (dprintffile != NULL) fprintf (dprintffile,"%s",Str);
      break;
    case dprintfOutputType_FileAppend :
...
#ifndef __WATCOM__
#ifndef _WINDOWS
    case dprintfOutputType_Com1 :
    case dprintfOutputType_Com2 :
      dpSerComPutStr (Str);
      break;
#endif
#endif
...
{
#ifndef NODPRINTF
	 if (( dprintfOutType == dprintfOutputType_Nothing) || (dprintfOutType == dprintfOutputType_Unknown)) return;
...
dprintfinittype::dprintfinittype () {
...
#ifdef _CONSOLE
#ifdef _DEBUG
  dprintfOutType = dprintfOutputType_Monochrome;
#else
  dprintfOutType = dprintfOutputType_Nothing;
#endif
#else
#endif
#ifdef _WINDOWS
  ...
  if (Str != NULL) {
    ...
    if (strstr(Buf,"MONO") != NULL) dprintfOutType = dprintfOutputType_Monochrome;
    if (strstr(Buf,"FILE") != NULL) dprintfOutType = dprintfOutputType_File;
    if (strstr(Buf,"FILEAPPEND") != NULL) dprintfOutType = dprintfOutputType_FileAppend;
    if (strstr(Buf,"COM1") != NULL) dprintfOutType = dprintfOutputType_Com1;
    if (strstr(Buf,"COM2") != NULL) dprintfOutType = dprintfOutputType_Com2;
    if (strstr(Buf,"STDOUT") != NULL) dprintfOutType = dprintfOutputType_STDOUT;
    if (strstr(Buf,"LPT1") != NULL) dprintfOutType = dprintfOutputType_LPT1;
    if (strstr(Buf,"LPT2") != NULL) dprintfOutType = dprintfOutputType_LPT1;
    if (strstr(Buf,"PRN") != NULL) dprintfOutType = dprintfOutputType_PRN;
  ...
  switch (dprintfOutType) {
    case dprintfOutputType_File :
      ...
      if (dprintffile == NULL) dprintfOutType = dprintfOutputType_Nothing;
      break;
    case dprintfOutputType_FileAppend :
      dprintffile = fopen ("DPRINTF.OUT","w");
      fclose (dprintffile);
