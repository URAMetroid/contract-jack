...
class CAbstractIO
{
    public:
        ...
        CAbstractIO&    operator << (unsigned long toWrite)    { Write(&toWrite, sizeof(toWrite)); return *this; }
        ...
        CAbstractIO&    operator >> (unsigned long &toRead)    { Read(&toRead, sizeof(toRead)); return *this; }
