...
enum eHUDUpdateFlag
{
	...
	kHUDBombTarget	= 0x00400000,
	kHUDWeaponHeat	= 0x00800000,
	kHUDAll			= 0xFFFFFFFF,
};
...
protected:
	...
	CHUDScores			m_Scores;
	CHUDBombTarget		m_BombTarget;
	CHUDCarrying		m_Carrying;
	CHUDWeaponHeat		m_WeaponHeat;
...
extern CHUDBombTarget*		g_pBombTarget;
extern CHUDCarrying*		g_pCarrying;
