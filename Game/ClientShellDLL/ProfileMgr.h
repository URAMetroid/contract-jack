...
//this should match the value in Launcher\LauncherDlg.cpp
...
{
public:
	CBindingData()	{ nStringID = 0; szAction[0] = '\0'; memset(strRealName, 0, sizeof(strRealName));
