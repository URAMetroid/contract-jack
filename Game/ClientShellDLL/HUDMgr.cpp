...
CHUDBombTarget*		g_pBombTarget = LTNULL;
CHUDCarrying*		g_pCarrying = LTNULL;
...
LTBOOL CHUDMgr::Init()
{
	...
	m_itemArray.push_back(&m_BombTarget);
	m_itemArray.push_back(&m_Carrying);
	m_itemArray.push_back(&m_WeaponHeat);
	...
	g_pScores = &m_Scores;
	g_pBombTarget = &m_BombTarget;
	g_pCarrying = &m_Carrying;
