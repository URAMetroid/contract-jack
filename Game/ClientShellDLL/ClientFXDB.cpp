...
static void SetupKey(FX_KEY* pKey, FX_PROP* pPropList, uint32 nNumProps)
{
	...
	for(uint32 nCurrProp = 0; nCurrProp < nNumProps; nCurrProp++)
	{
		...
		{
			switch( fxProp.GetComboVal( ))
			{
				default:
				case 0:
					pKey->m_eGoreSetting = FX_KEY::eGoreSetting_No;
					break;
				case 1:
					pKey->m_eGoreSetting = FX_KEY::eGoreSetting_Yes;
					break;
				case 2:
					pKey->m_eGoreSetting = FX_KEY::eGoreSetting_LowViolenceOnly;
					break;
			}
		}
	}
