...
public:
	...
	bool		LaunchPatchUpdate( char const* pszUrl );
...
public:
    ...
    void        HandleWeaponPickup(uint8 nWeaponId, bool bSuccess, bool bActivatingPickup );
    void        HandleGearPickup(uint8 nGearId, bool bSucces, bool bActivatingPickup );
    void        HandleModPickup(uint8 nModId, bool bSucces, bool bActivatingPickup );
    void        HandleAmmoPickup(uint8 nAmmoId, int nAmmoCount, bool bSuccess, bool bActivatingPickup, uint8 nWeaponId = WMGR_INVALID_ID);
