...
#define SFX_CHASSISPIECE_ID			58
#define SFX_CHASSIS_ID				59
#define SFX_AIMMAGNET_ID			60
#define SFX_TOTAL_NUMBER			60	// Important that this is the same as the last FX defined...
...
//sub-messages for CFX_CARRY
	...
	#define	CFX_CARRY_CHASSIS_PIECE			2
#define CFX_PLAYER_PHYSICS_MODEL		38
...
enum PlayerVehicleFXMsgs
{
	kPlayerVehicleStartFade,
	kPlayerVehicleStopFade,
	kPlayerVehicleRespawn
};
