...
bool CServerDlg::RunServer()
{
	...
	{
		uint32 nMsgId = IDS_ERROR_BINARIES;
		switch( m_ServerGameOptions.m_eServerStartResult )
		{
			default:
				break;
			case eServerStartResult_Failed:
				nMsgId = IDS_NETERR_HOSTSESSION;
				break;
...
bool CServerDlg::InitErrorLog( )
{
	...
	{
		m_sErrorLogFileName = "server.log";
	}
