...
public:
	...
	BOOL	m_bEnableScreenshots;			// Enables in-game screenshots
	...
	// Registry helpers
	BOOL	GetRegistryBool(char *szField,BOOL bDefault = FALSE);
	DWORD	GetRegistryDWord(char *szField, DWORD dwDefault = 0);
