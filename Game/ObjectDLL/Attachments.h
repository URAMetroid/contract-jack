...
#define ADD_ATTACHMENTS_AGGREGATE_FLAG( flag ) \
	PROP_DEFINEGROUP(Attachments, PF_GROUP(6) | ( flag )) \

#define ADD_ATTACHMENTS_AGGREGATE() \
	ADD_ATTACHMENTS_AGGREGATE_FLAG( 0 )

#define ADD_HUMANATTACHMENTS_AGGREGATE_FLAG( flag ) \
	ADD_ATTACHMENTS_AGGREGATE_FLAG( flag ) \
		ADD_STRINGPROP_FLAG(LeftHand,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightHand,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(Head,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(Eyes,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(Nose,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(Chin,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(Back,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftFoot,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightFoot,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(Snowmobile,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(Light,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftLowerArm,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftUpperArm,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightLowerArm,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightUpperArm,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftLowerLeg,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftUpperLeg,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightLowerLeg,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightUpperLeg,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(UpperTorso,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(Torso,			NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftShoulder,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightShoulder,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightHand2,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftHand2,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftLowerArm2,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftLowerLeg2,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftUpperArm2,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(LeftUpperLeg2,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightUpperArm2,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightUpperLeg2,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightLowerArm2,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(RightLowerLeg2,	NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \
		ADD_STRINGPROP_FLAG(UpperTorso2,		NO_ATTACHMENT,		PF_GROUP(6)|PF_STATICLIST|(flag)) \

#define ADD_HUMANATTACHMENTS_AGGREGATE() \
	ADD_HUMANATTACHMENTS_AGGREGATE_FLAG( 0 )
...
class CAttachments : public IAggregate
{
	public :
		...
		virtual void HideAttachments(LTBOOL bHide);
