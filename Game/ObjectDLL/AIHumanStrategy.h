...
class CAIHumanStrategyFollowPath : public CAIHumanStrategy
{
	...
	public :
		...
		LTBOOL	StartedToOpenDoor() const { return m_bStartedToOpenDoor; }
...
class CAIHumanStrategyGrenade : public CAIHumanStrategy
{
	...
	public :
		...
		virtual LTBOOL ShouldThrow( LTFLOAT fProbabilityFactor ) { return LTFALSE; }
...
class CAIHumanStrategyGrenadeThrow : public CAIHumanStrategyGrenade
{
	...
	public :
		...
		LTBOOL ShouldThrow( LTFLOAT fProbabilityFactor );
		LTBOOL IsThrowing();
