...
class AIVolumePlayerInfo : public AIInformationVolume
{
	...
	public :
		...
		AINode* FindViewNode(CAI* pAI, EnumAINodeType eNodeType, const LTVector& vPos, LTBOOL bMustBeUnowned, HOBJECT hThreat) const;
		AINode* FindOwnedViewNode(CAI* pAI, EnumAINodeType eNodeType, HOBJECT hOwner, HOBJECT hThreat) const;
