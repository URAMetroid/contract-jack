...
class AINode : public GameBase
{
	...
	public :
		...
		virtual EnumNodeStatus	GetStatus( CAI* pAI, const LTVector& vPos, HOBJECT hThreat) const { return kStatus_Ok; }
...
class AINodeCover : public AINodeChangeWeapons
{
	...
	public :
		...
		LTFLOAT	GetPlayerRadiusSqr() const { return m_fPlayerRadiusSqr; }
