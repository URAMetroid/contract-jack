...
class CAIHumanStateAttackFromCover : public CAIHumanState
{
	...
	public :
		...
		void SetOrderedCover(LTBOOL bOrdered) { m_bOrderedCover = bOrdered; }
...
class CAIHumanStateCharge : public CAIHumanState
{
	...
	public :
		...
		void SetChargeFromNode(LTBOOL bChargeFromNode) { m_bChargeFromNode = bChargeFromNode; }
