...
class Body : public Prop, public IHitBoxUser
{
	...
	public : // Public methods
		...
		void			AddWeapon(HOBJECT hWeapon, const char *pszPosition);
	...
	protected :
		...
		// Hack for dealing with the situation where the prop deactivates the object,
		// which toggles a flag, and the body re-activates it, which toggles the
		// flag back, causing bad network mojo.
